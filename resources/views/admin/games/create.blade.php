...
@section('page-title', 'Crear Juego')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-[#F5F5F5] mt-2">
                Agrega un nuevo juego a la plataforma
            </p>
        </div>
                ...
                <div class="flex justify-center mb-6">
                    <div class="relative">
                        <div class="w-32 h-32 rounded-xl overflow-hidden bg-[#1F1F1F] border-2 border-[#FDC900] flex items-center justify-center">
                            <img id="imagePreview" 
                                 src="/assets/default-game.svg" 
                                 alt="Preview"
                                 class="w-full h-full object-cover">
                        </div>
                        <button type="button" 
                                id="removeImageBtn"
                                class="absolute -top-2 -right-2 bg-red-500 hover:bg-red-600 text-white rounded-full w-6 h-6 items-center justify-center transition-colors hidden">
                            ✕
                        </button>
                    </div>
                </div>
